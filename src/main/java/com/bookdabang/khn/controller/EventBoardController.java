...
public class EventBoardController {
	...
	public String readEvent(@RequestParam("boardno") String boardno, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String deleteEvent(@RequestParam("boardno") String boardno, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String eventUpdatePage(@RequestParam("boardno") String boardno, Model model, HttpServletRequest request)
			throws Exception {
		int no = Integer.parseInt(boardno);
		EventBoardVo detailEvent = service.readDetailEvent(no);
		model.addAttribute("detailEvent", detailEvent);
