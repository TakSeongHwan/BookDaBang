...
public class AdminProduct {
	...
	public AdminProduct(int product_no, String title, String author, int price, int sell_price, String publisher,
			...
			String pisOffdiscription, String isbn, String isbn13, int reviewCount, String category_name) {
		super();
	...
	public String toString() {
		return "AdminProduct [product_no=" + product_no + ", title=" + title + ", author=" + author + ", price=" + price
				...
				+ pisOffdiscription + ", isbn=" + isbn + ", isbn13=" + isbn13 + ", reviewCount=" + reviewCount
