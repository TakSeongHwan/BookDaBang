...
public class AdminPagingInfo {

	private int postPerPage = 10; // 1페이지당 보여 줄 글의 개수
	...
	public AdminPagingInfo() {

	}

	public AdminPagingInfo(int postPerPage, int pageCntPerBlock, int totalPage, int totalPostCnt, int startNum,
	...
	public String toString() {
		return "AdminPagingInfo [postPerPage=" + postPerPage + ", pageCntPerBlock=" + pageCntPerBlock + ", totalPage="
