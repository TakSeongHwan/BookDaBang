...
public class UploadFile {
	...
	private String thumbnailFileName; // 이미지 파일일 경우, 썸네일 이미지 파일 이름
	private String notImageFileName; // 이미지 파일이 아닌 경우, 파일 이름
	
	public UploadFile() {
		super();
	}

	public UploadFile(String originalFileName, String thumbnailFileName, String notImageFileName) {
		super();
