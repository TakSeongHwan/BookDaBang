		...
		<div class="layout-container"
			...
			<aside id="layout-menu"
				...
				<div class="app-brand demo">
					<a href="${contextPath}/admin" class="app-brand-link"> <span
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item"><a href="javascript:void(0);"
						class="menu-link menu-toggle"> <i
							...
							<div data-i18n="Account Settings"
								onclick="location.href='${contextPath}/admin/adminMember/listAll'">회원
								조회</div>
					</a></li>
					...
					<li class="menu-item"><a href="javascript:void(0);"
						class="menu-link menu-toggle"> <i
							class="menu-icon tf-icons bx bx-dock-top"></i>
							<div data-i18n="Account Settings"
								onclick="location.href='${contextPath}/admin/refundBoard/boardList?pageNo=1'">환불
								조회</div>
					</a></li>
