...
<link rel="icon" type="image/x-icon"
	href="${contextPath}/resources/assets/img/favicon/favicon.ico" />
<!-- Fonts -->
...
<link rel="stylesheet"
	href="${contextPath}/resources/assets/vendor/fonts/boxicons.css" />
<!-- Core CSS -->
<link rel="stylesheet"
	href="${contextPath}/resources/assets/vendor/css/core.css"
	class="template-customizer-core-css" />
<link rel="stylesheet"
	href="${contextPath}/resources/assets/vendor/css/theme-default.css"
...
<body>
	<div class="layout-wrapper layout-content-navbar">
		<div class="layout-container"
			...
			<aside id="layout-menu"
				...
				<div class="app-brand demo">
					<a href="${contextPath}/admin?sessionId=${sessionId}"
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item"><a href="javascript:void(0);"
						...
						<ul class="menu-sub">
							...
							<li class="menu-item"><a
								href="${contextPath}/admin/adminStatistics/visitorChartDetail"
								class="menu-link">
									<div data-i18n="Without navbar">방문자 통계 상세조회</div>
							</a></li>
							<li class="menu-item"><a
								href="${contextPath}/admin/adminStatistics/salesDataDetail"
								class="menu-link">
									<div data-i18n="Container">판매량 통계 상세조회</div>
							</a></li>
							<li class="menu-item"><a
								href="${contextPath}/admin/adminStatistics/allSalesDetail"
								class="menu-link">
					...
					<li class="menu-item"><a href="javascript:void(0);"
						class="menu-link menu-toggle"> <i
							...
							<div data-i18n="Account Settings"
								onclick="location.href='${contextPath}/admin/adminMember/listAll'">회원 관리</div>
					</a></li>
					</a>
					<li class="menu-header small text-uppercase"><span
					...
					<li class="menu-item"><a href="javascript:void(0);"
						class="menu-link menu-toggle"> <i
							class="menu-icon tf-icons bx bx-dock-top"></i>
							<div data-i18n="Account Settings" id="productManager">상품 관리
							</div>
					</a>
						<ul class="menu-sub">
							<li class="menu-item"><a
								onclick="location.href='${contextPath}/prodManager/listAll'"
								class="menu-link">
							...
							<li class="menu-item"><a
								onclick="location.href='${contextPath}/prodManager/SearchISBN'"
								class="menu-link">
					...
					<li class="menu-item"><a href="javascript:void(0);"
						...
						<ul class="menu-sub">
							...
							<li class="menu-item"><a href="auth-register-basic.html"
								class="menu-link" target="_blank"
								onclick="location.href='${contextPath}/prodManager/listAllofQnA'">
                  ...
                  <ul class="menu-sub">
					...
					<li class="menu-item"><a href="javascript:void(0);"
						...
						<ul class="menu-sub">
							<li class="menu-item"><a
								href="${contextPath}/board/removeAllfreeBoard" class="menu-link">
									<div data-i18n="Error">삭제게시판</div>
							</a></li>
							<li class="menu-item"><a
								href="${contextPath}/board/listAllReportBoard"
								" class="menu-link">
					...
					<li class="menu-item"><a href="javascript:void(0);"
						class="menu-link menu-toggle"> <i
							class="menu-icon tf-icons bx bx-dock-top"></i>
							<div data-i18n="Account Settings"
								onclick="location.href='${contextPath}/admin/adminOrder/orderListAll'">주문
								조회</div>
					</a></li>
					<li class="menu-item"><a href="javascript:void(0);"
						class="menu-link menu-toggle"> <i
							class="menu-icon tf-icons bx bx-dock-top"></i>
							<div data-i18n="Account Settings"
								onclick="location.href='${contextPath}/admin/refundBoard/boardList?pageNo=1'">환불상품</div>
					</a></li>
		...
		<div class="content-wrapper">
			...
			<script
				src="${contextPath}/resources/assets/vendor/libs/jquery/jquery.js"></script>
			<script
				src="${contextPath}/resources/assets/vendor/libs/popper/popper.js"></script>
			<script src="${contextPath}/resources/assets/vendor/js/bootstrap.js"></script>
			<script
				src="${contextPath}/resources/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
			...
			<!-- Vendors JS -->
			<script
				src="${contextPath}/resources/assets/vendor/libs/apex-charts/apexcharts.js"></script>
			...
			<!-- Page JS -->
			<script
				src="${contextPath}/resources/assets/js/dashboards-analytics.js"></script>
