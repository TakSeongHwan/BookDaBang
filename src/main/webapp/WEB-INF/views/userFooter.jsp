					...
					<div class="col-lg-2 col-md-6 col-sm-6">
						<div class="single-footer-widget instafeed">
							...
							<ul class="list instafeed d-flex flex-wrap">
								<li><img src="${contextPath}/resources/img/gallery/r1.jpg"
									alt=""></li>
								<li><img src="${contextPath}/resources/img/gallery/r2.jpg"
									alt=""></li>
								<li><img src="${contextPath}/resources/img/gallery/r3.jpg"
									alt=""></li>
								<li><img src="${contextPath}/resources/img/gallery/r5.jpg"
									alt=""></li>
								<li><img src="${contextPath}/resources/img/gallery/r7.jpg"
									alt=""></li>
								<li><img src="${contextPath}/resources/img/gallery/r8.jpg"
									alt=""></li>
							</ul>
						</div>
					</div>
