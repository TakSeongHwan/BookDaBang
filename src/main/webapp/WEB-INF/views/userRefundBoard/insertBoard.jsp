...
<body>
	...
	<div class="container">
		...
		<div class="comment-form">
			<h4 style="text-align: left;">환불 요청 글 등록</h4>
			<form method="post" action="/userRefundBoard/board">
				<div class="mb-3 mt-3">
				...
				<div class="mb-3">
					<button type="button" class="btn btn-default" onclick="openArea();"
						style="float: left;">파일 업로드</button>
					<div class="fileDrop">
