			...
			<div class="container">
				...
				<div class="tab-content" id="myTabContent">
					...
					<div class="tab-pane fade" id="contact" role="tabpanel"
						...
						<textarea class="form-control" id="qnaContent" id=index " rows="8"></textarea>
						<a class="button button--active button-contactForm" id="insertQnA" style="color : #fff">글등록</a>
						<div style ="float: right;  display : inline-block;">
						<label class="form-label">비밀번호 입력(선택)</label>
						<input type="text" class="form-control" id="pwd" placeholder="하던가 말던가" aria-describedby="defaultFormControlHelp" style="width:200px; " />
						</div>
