		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="${contextPath}/"><img
						src="${contextPath}/resources/LOGO3.png" alt=""></a>
					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto mr-auto">
							...
							<li class="nav-item active"><a class="nav-link"
								href="${contextPath}/product/list">도서</a></li>
							<li class="nav-item active"><a class="nav-link"
								href="${contextPath}/notice/listAll">공지사항</a></li>
                   ...
                   <ul class="dropdown-menu">
							...
							<li class="nav-item submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link"
										href="${contextPath}/login.html">Login</a></li>
									<li class="nav-item"><a class="nav-link"
						...
						<ul class="nav-shop">
							...
							<li class="nav-item"><form
									action="${contextPath }/cart/userCart" method="get">
									<button type="submit">
										<i class="ti-shopping-cart"></i><span class="nav-shop__circle"
											id="cntCart"></span>
									</button>
								</form></li>
							<li class="nav-item"><button type="button"
									onclick="loginOrNot();">
									<img src="${contextPath }/resources/img/user_icon.png"
