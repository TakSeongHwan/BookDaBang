...
function viewComment(data) {
	...
	$.each(data, function(i, e) {
			...
			output += '<div>';
			output += '<div><div id="rep' + e.commentno+ '" >' + e.commentwriter + '</div>';
			output += '<div>내용 : ' + e.commentcontent + '</div>';
...
<body>
		...
		<div class="comment-form">
			...
			<div class="mb-3">
				<textarea class="form-control" rows="10" id="content" name="content"
					readonly="readonly">내용  : ${freeBoard.content }
			...
			<button class="button button-postComment button--active"
				type="button" id="btn2" style="display: none;"
				onclick="location.href='/board/modifyFreeBoard?boardno='+${freeBoard.boardno };">수정하기</button>
			<button class="button button-postComment button--active"
			...
			<div class="mb-3" style="clear: both;">
				...
				<textarea class="form-control" rows="5" id="commentContent"
					name="text" style="border-color: #ADD8E6;">
			</textarea>
			</div>
			...
			<button class="button button-postComment button--active"
				type="button" id="btn3" onclick="history.back();">목록</button>
		</div>
	...
	<div id="modiCommentDiv" style="display: none;">
		...
		<textarea class="form-control" rows="5" id="modyComment"
			name="modyComment" style="border-color: #ADD8E6; margin-top: 10px;">
			</textarea>
