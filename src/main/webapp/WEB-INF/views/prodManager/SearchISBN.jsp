...
<body>
	...
	<div class="container2"
		style="height: 100%; width: 0px; background-color: #B4C6F7; position: absolute; z-index: 999;">

	</div>

	<div style="height: 300px"></div>
	<div class="cotatiner">
		<div style="text-align: center; font-size: 36px;">ISBN으로 수정하실
			상품을 검색하세요!</div>
		<div style="width: 650px; margin: 0 auto; margin-top: 30px">

			<input type="text" class="form-control searchText"
				style="width: 560px; height: 50px; display: inline-block;">
			<button type="button" class="btn btn-primary searchBtn"
				style="height: 50px; margin-bottom: 3px">검색</button>
		</div>
	</div>
	<div class="container3"
		style="width: 420px; margin: 0 auto; margin-top: 30px; font-size: 42px; display: none;">페이지로
		이동합니다</div>
